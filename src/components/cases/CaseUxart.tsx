...
export function CaseUxart() {
  ...
  return (
    <CaseNarrative
      ...
      tags={
        ru
          ? ["AI-трансформация", "Дизайн-операции", "Сервис-дизайн", "2025"]
          ...
          ? [
                ...
                support: [
                  {
                    ...
                    body: "Решения создавались не для абстрактной «дизайн-команды». Ими должны были пользоваться отдел продаж и аккаунт-менеджеры при подготовке КП, дизайнеры и арт-дирекция в пресейле, а руководители — для контроля качества и экономики процесса.",
                  },
                  {
                    title: "Главный риск",
              ...
              },
              {
                ...
                bullets: [
                  ...
                  "Запустить пилоты, встроить обязательную проверку человеком и зафиксировать правила масштабирования.",
                ],
              },
              {
                code: "A1",
                label: "Аудит процессов",
                ...
                support: [
                  ...
                  {
                    title: "Критерий: AI или обычная автоматизация",
              ...
              },
              {
                ...
                bullets: [
                  ...
                  "Контроль: обязательная проверка человеком перед экспортом.",
                ],
                support: [
                  {
              ...
              },
              {
                code: "A3",
                label: "Пресейлы с AI",
                body: "Для наиболее ценных лидов мы усилили стандартный пресейл интерактивным AI-прототипом, собранным за 3–4 дня. Он шёл вместе с презентацией и коммерческим предложением — не заменял их, а давал клиенту возможность «потрогать» возможное направление до подписания договора.",
                support: [
                  {
              ...
              },
              {
                ...
                body: "Чтобы практика не зависела от конкретного инструмента, я оформил собственный фреймворк: Исследование → Оценка → Прототип → Проверка → Интеграция → Масштабирование. Он помогает команде начинать с узкого места процесса, выбирать подходящую технологию и масштабировать только проверенный сценарий.",
                bullets: [
                  "Исследование — наблюдение и интервью с участниками процесса.",
                  "Оценка — ценность, частота, ручное время, ошибки и стабильность контекста.",
                  "Прототип — самый короткий сквозной пилот на реальных данных.",
                  "Проверка — качество результата, время, ошибки и доверие пользователя.",
                  "Интеграция — владельцы, проверка человеком, документация и передача.",
                  "Масштабирование — обучение, повторное использование и регулярный пересмотр метрик.",
                ],
              },
              {
                code: "A5",
                label: "Внедрение",
                body: "Я провёл обучение команды и зафиксировал правила работы с AI-результатом: единый источник правды, известные ограничения, ответственные за визуальную и интерактивную проверку, README для передачи и список того, что обязательно проверяет человек.",
                support: [
                  {
              ...
              },
              {
                ...
                metrics: [
                  ...
                  { value: "80%", label: "Внедрение AI", detail: "оценка доли дизайн-команды" },
