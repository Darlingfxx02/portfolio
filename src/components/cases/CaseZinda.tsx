...
export function CaseZinda() {
  ...
  return (
    <CaseNarrative
      ...
      intro={
        ru
          ? "Я присоединился после трёх отклонённых концепций, стабилизировал дизайн-процесс и помог свести в один продукт три конкурирующих видения: банка, брендинговой студии и продуктовой команды. За шесть месяцев мы довели веб- и мобильную версии MVP до передачи в разработку."
      ...
      tags={
        ru
          ? ["Продуктовый дизайн", "Финтех · B2B", "Веб + мобильные", "6 месяцев"]
      ...
      sections={
        ru
          ? [
              ...
              {
                code: "A2",
                label: "Команда и ответственность",
              ...
              {
                code: "A3",
                label: "Согласование со стейкхолдерами",
              ...
              },
              {
                code: "R",
                label: "Результат",
                body: "За шесть месяцев мы подготовили веб- и мобильную версии MVP и передали продукт в дальнейшую разработку. После этого банк продолжил развиваться в сторону кредитных и денежных сервисов, а заказчик приглашал меня остаться в команде.",
                metrics: [
                  { value: "6 мес.", label: "MVP", detail: "от перезапуска концепции до передачи в разработку" },
